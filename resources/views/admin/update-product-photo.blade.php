        ...
        <div class="main-content-inner">
            <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li class="active">Update Product Photo</li>
                </ul><!-- /.breadcrumb -->
            ...
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <form class="form-horizontal" role="form" method="POST" action="{{ route('product.productPhotoUpdate', $productPhoto->id) }}" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                {{csrf_field()}}
                                <div class="col-sm-9">
                                    <input name="image" type="file" id="form-field" multiple="multiple" value="{{$productPhoto->image}}"  class="col-xs-10 col-sm-5" />
                                </div>
                            </div>
