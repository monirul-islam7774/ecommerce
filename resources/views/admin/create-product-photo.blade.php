        ...
        <div class="main-content-inner">
            <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li>
                        <a href="{!! URL::route('productPhoto.index') !!}">Product Photo</a>
                    </li>
                    <li class="active">Create Product Photo</li>
                </ul><!-- /.breadcrumb -->
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <!-- PAGE CONTENT BEGINS -->
                            ...
                            <form class="form-horizontal" role="form" method="POST" action="{{ route('product.productPhotoStore') }}" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="hidden" name="productCode" value="{{$id}}">
                                </div>
