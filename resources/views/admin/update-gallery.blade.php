        ...
        <div class="main-content-inner">
            <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li class="active">Update Gallery Info</li>
                </ul><!-- /.breadcrumb -->
            ...
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <form class="form-horizontal" role="form" method="POST" action="{{ route('galleryUpdate', $gallery->id) }}" enctype="multipart/form-data">

                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right" for="form-field-1">Image Title </label>
                                {{csrf_field()}}
                                <div class="col-sm-9">
                                    <input name="title" type="text" id="form-field-1"  class="col-xs-10 col-sm-5" value="{{ $gallery->title }}" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right" for="form-field-1">Gallery Image </label>
                                <div class="col-sm-9">
                                    <input name="image" type="file" id="form-field"  value="{{$gallery->image}}"  class="col-xs-10 col-sm-5" />
                                </div>
                            </div>
