                    ...
                    <div class="col-xs-12">
                        <div >
                            @if(!empty($id))
                                ...
                                <a class="btn btn-success" href="{{ route('menu.create',$id) }}"> Create New Menu</a>
                            @endif
                            @if(empty($id))
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <h3 class="header smaller lighter blue">Menu Table</h3>

                                <div class="clearfix">
                                    <div class="pull-right tableTools-container"></div>
                                </div>
                                <div class="table-header">
                                    Results for "Menu Crud"
                                </div>
                                    ...
                                    <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                                        ...
                                        @foreach ($menus as $key => $menu)
                                            <tr>
                                                ...
                                                <td class="hidden-480">
                                                    <span class="label label-sm label-warning">{{ $menu->status }}</span>
                                                </td>

                                                <td>
                                                    <div class="hidden-sm hidden-xs action-buttons">
                                                        <a class="blue" href="{{ route('menu.changeStatus',$menu->id) }}">
                                                            <i class="ace-icon fa fa-key bigger-130"></i>
                                                        </a>
                                                        <a class="blue" href="{{ route('menu.index',$menu->id) }}">
                                                            <i class="ace-icon fa fa-list bigger-130"></i>
                                                        </a>
                                                        <a class="blue" href="{{ route('menu.create',$menu->id) }}">
                                                            <i class="ace-icon fa fa-plus bigger-130"></i>
                                                        </a>

                                                        <a class="green" href="{{ route('menu.edit',$menu->id) }}">
                                                            <i class="ace-icon fa fa-pencil bigger-130"></i>
                                                        </a>

                                                        <a class="red" href="{{ route('menu.destroy',$menu->id) }}">
