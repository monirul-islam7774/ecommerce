            ...
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <h3 class="header smaller lighter blue">Product Photo Table</h3>

                                <div class="clearfix">
                                    <div class="pull-right tableTools-container"></div>
                                </div>
                                <div class="table-header">
                                    Results for "Product Photo Crud"
                                </div>
                                ...
                                <div>
                                    ...
                                    <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                                        ...
                                        <tbody>
                                        @foreach ($productPhotos as $key => $product)
                                            <tr>
                                                <td class="center">
                                                    <label class="pos-rel">
                                                        <input type="checkbox" class="ace" />
                                                ...
                                                <td><img src="{{ asset('product-images/'.$product->image)}}" height="30px" width="30px" /></td>

                                                <td>
                                                    <div class="hidden-sm hidden-xs action-buttons">

                                                        <a class="green" href="{{ route('product.productPhotoEdit',$product->id) }}">
                                                            <i class="ace-icon fa fa-pencil bigger-130"></i>
                                                        </a>

                                                        <a class="red" href="{{ route('product.productPhotoDestroy',$product->id) }}">
