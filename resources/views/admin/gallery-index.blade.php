                ...
                <div class="row">
                    <div class="col-xs-12">
                        <div >
                                ...
                                <a class="btn btn-success" href="{{ route('gallery.create') }}"> Add New Photos</a>
                        </div>
                        <div class="row">
                            <div class="col-xs-12">
                                <h3 class="header smaller lighter blue">Gallery Table</h3>

                                <div class="clearfix">
                                    <div class="pull-right tableTools-container"></div>
                                </div>
                                <div class="table-header">
                                    Results for "Gallery Crud"
                                </div>
                                    ...
                                    <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                                        ...
                                        @foreach ($gallery as $key => $product)
                                            <tr>
                                                ...
                                                <td>{{ $product->title }}</td>
                                                <td><img src="{{ asset('gallery-images/'.$product->image)}}" height="40px" width="60px" /></td>
                                                <td>{{ $product->image }}</td>
                                                <td>
                                                    <div class="hidden-sm hidden-xs action-buttons">

                                                        <a class="green" href="{{ route('galleryEdit',$product->id) }}">
                                                            <i class="ace-icon fa fa-pencil bigger-130"></i>
                                                        </a>

                                                        <a class="red" href="{{ route('gallery.destroy',$product->id) }}">
