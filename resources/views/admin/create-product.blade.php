            ...
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <form class="form-horizontal" role="form" method="POST" action="{{ route('product.productStore') }}" enctype="multipart/form-data">
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right" for="form-field-1">Product Name </label>
                                {{csrf_field()}}
                                <div class="col-sm-9">
                                    <input name="name" type="text" id="form-field-1" placeholder="ProductName" class="col-xs-10 col-sm-5" required />
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right" for="form-field-1">Product Code </label>
                                <div class="col-sm-9">
                                    <input name="productCode" type="text" id="form-field-1" placeholder="Product Code" class="col-xs-10 col-sm-5" required />
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right" for="form-field-1">Product Color </label>
                                <div class="col-sm-9">
                                    <input name="color" type="text" id="form-field-1" placeholder="Product Color" class="col-xs-10 col-sm-5" required />
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right" for="form-field-1">Product Size </label>
                                <div class="col-sm-9">
                                    <input name="size" type="text" id="form-field-1" placeholder="Product Size" class="col-xs-10 col-sm-5" required />
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Product Price </label>
                                <div class="col-sm-9">
                                    <input name="price" type="text" id="form-field-1" placeholder="ProductPrice" class="col-xs-10 col-sm-5" required/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Product Details </label>
                                <div class="col-sm-9">
                                    <textarea name="details"  id="form-field-1" placeholder="Product Details" class="col-xs-10 col-sm-5" required/></textarea>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right" for="form-field-1">Product Offer Percentage </label>
                                <div class="col-sm-9">
                                    <input name="offerPercentage" type="text" id="form-field-1" placeholder="ProductOfferPercentage" class="col-xs-10 col-sm-5" />
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <select name="categoryId" id="categoryId" class="form-control" required>
                                        @foreach($menus as $category)
                                            <option value="{{$category->id}}"> {{$category->menuTitle}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right" for="form-field-1" required> Product Status </label>
                                <div class="col-sm-9">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input name="image" type="file" id="form-field" class="col-xs-10 col-sm-5" required/>
                                </div>
                            </div>
