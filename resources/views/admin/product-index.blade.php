            ...
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <h3 class="header smaller lighter blue">Product Table</h3>

                                <div class="clearfix">
                                    <div class="pull-right tableTools-container"></div>
                                </div>
                                <div class="table-header">
                                    Results for "Product Crud"
                                </div>
                                ...
                                <div>
                                    ...
                                    <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                                        ...
                                        <tr>
                                            ...
                                            <th class="hidden-480">Product Status</th>
                                            <th >Product Image</th>
                                            <th>Action</th>
                                        </tr>
                                        </thead>
                                        ...
                                        @foreach ($products as $key => $product)
                                            <tr>
                                                ...
                                                <td class="hidden-480">
                                                    <span class="label label-sm label-warning">{{ $product->status }}</span>
                                                </td>
                                                <td><img src="{{ asset('images/'.$product->image)}}" height="30px" width="30px" /></td>

                                                <td>
                                                    <div class="hidden-sm hidden-xs action-buttons">

                                                        <a class="blue" href="{{ route('productPhoto.create',$product->productCode) }}">
                                                            <i class="ace-icon fa fa-plus bigger-130"></i>
                                                        </a>
                                                        <a class="green" href="{{ route('product.productEdit',$product->id) }}">
                                                            <i class="ace-icon fa fa-pencil bigger-130"></i>
                                                        </a>

                                                        <a class="red" href="{{ route('product.destroy',$product->id) }}">
