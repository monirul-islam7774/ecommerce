            ...
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <!-- PAGE CONTENT BEGINS -->
                        @if(!empty($id))
                            <form class="form-horizontal" role="form" method="POST" action="{{ route('menu.store',$id) }}">
                        @endif
                        @if(empty($id))
                        ...
                        @endif
                            ...
                            <div class="form-group">
                                ...
                                {{csrf_field()}}
                                <div class="col-sm-9">
                                    <input name="menuTitle" type="text" id="form-field-1" placeholder="MenuName" class="col-xs-10 col-sm-5" required/>
                                </div>
                            </div>
